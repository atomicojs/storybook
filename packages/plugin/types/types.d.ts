...
export type Controls = ControlColor<"color"> | ControlGeneric<"object" | "boolean" | "text" | "date"> | ControlFile | ControlRange<"number" | "range"> | ControlOptions<"radio" | "select" | "inline-radio" | "check" | "multi-select">;
export type Types = TypeGeneric | TypeEnum | TypeArray | TypeObject | TypeInserction | TypeUnion | TypeOther;
