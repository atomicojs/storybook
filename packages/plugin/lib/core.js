...
import 'atomico';
import './serialize-dom.js';
import './serialize-jsx.js';

const getAutoControl = (prop, type) => options.match.find(
...
const defineArgTypes = (component, argTypes) => define(component, { argTypes }).argTypes;
const defineArgs = (component, argTypes) => define(component, { argTypes }).args;

export { define, defineArgTypes, defineArgs, options };
