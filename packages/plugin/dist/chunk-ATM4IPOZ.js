...
var serialize = (children, tab = 0, currentId) => [...children].reduce((html, child) => {
  ...
  if (child instanceof Element) {
    ...
    const { _props = {}, constructor } = child;
    ...
    let content = ignore.includes("children") ? "" : serialize(childNodes, tab + 1, currentId);
    if (content) {
      content += `
${space}`;
    }
